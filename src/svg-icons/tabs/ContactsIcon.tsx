...
export const ContactsIconOutline = ({ color = DEFAULT_COLOR }: TabIconProps) => {
  return (
    <Svg width="49" height="40" viewBox="0 0 49 40" fill="none">
      <Circle cx="24" cy="14" r="6" stroke={color} strokeWidth="1.5" />
      <Path
...
export const ContactsIconFilled = ({ color = DEFAULT_COLOR }: TabIconProps) => {
  return (
    <Svg width="49" height="40" viewBox="0 0 49 40" fill="none">
      <Path
