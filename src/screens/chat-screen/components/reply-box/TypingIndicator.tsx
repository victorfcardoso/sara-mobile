    ...
    <View style={tailwind.style('absolute w-full items-center -top-14')}>
      <View
        style={tailwind.style(
          'flex-row items-center py-1 px-4 shadow-md rounded-full bg-[#F1F6F5] my-1 mx-auto',
        )}>
        <Text
          style={tailwind.style(
            'text-cxs font-inter-medium-24 tracking-[0.32px] leading-[18px] text-[#16273D] text-center',
          )}>
          {typingText}
        </Text>
        <Image
